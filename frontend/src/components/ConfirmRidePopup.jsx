...
const ConfirmRidePopup = ({confirmRidePopupRef, setConfirmRidePopup, setRidePopupPanle }) => {
  return (
    ...
    className="fixed w-full z-10 bottom-0 h-screen bg-white translate-y-full  py-3 -ml-3 lg:-ml-12 px-4  "
  >
    ...
    <div className="flex justify-between items-center mt-4  p-3 lg:p-2  bg-gray-100 border-2 border-gray-300 rounded-lg">
      ...
      <h5 className="text-base lg:text-lg font-semibold text-gray-600">2.2 km away</h5>
    </div>
